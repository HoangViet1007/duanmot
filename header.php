<?php
    ...
    // lấy za banner ảnh từ bảng slide_anh
    $sql = "SELECT * FROM slide_anh" ; 
    $slide_anh = select_all($sql) ;
    ...
    <div class="container-fluid header-top">
        <div class="row" style="border-bottom: 1px solid #F0F0F0;">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <img src="<?php echo $kh['logo'] ?>" alt="" class="header-img-logo">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <ul class="main-menu nav1" style="float:right; margin-right: -30px;">
                            ...
                            <li class="nav-item" style="padding-top: 10px; width: 115px;">
            ...
            <div class="row main-banner">
                <div class="col-md-12">
                    <div class="banner">
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <?php foreach ($slide_anh as $key) { ?>
                                    <?php if($active == 'active') { ?>
                                        <div class="carousel-item active">
                                            <img src="<?php echo BASE_URL. $key['hinh'] ?>" class="d-block" width="100%" alt=""
                                                height="800px" style="margin-top:15px ;">
                                        </div>
                            ...
                            <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button"
                                data-slide="prev" style="z-index: 999;">
                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                <span class="sr-only">Previous</span>
                            </a>
                            <a class="carousel-control-next" href="#carouselExampleIndicators" role="button"
                                data-slide="next" style="z-index: 999;">
                    ...
                    <div class="animate text-center"
                        style="position: absolute;top: 40%; color: white; z-index: 99;width: 100%;">
                        <h4
                            style="text-transform: uppercase;font-family:'Playfair Display', serif; margin-bottom: 20px;">
                            See What a Difference a stay makes</h4>
                        <h1
                            style="text-transform: uppercase;font-family:'Playfair Display', serif;font-size: 50px; margin-bottom: 20px; ">
                            Luxury <em>is</em> personal</h1>
                        <a class="button home-banner-btn" href="<?php echo BASE_URL ?>list-type-room.php">Book Now</a>
                    </div>
                </div>
            </div>
        </div>
