<?php
    ...
    $data = 6;
    $sql = "SELECT count(*) FROM `slide_anh`";
    $conn = connect();
    ...
    $sql = "select * from slide_anh LIMIT $tin , $data" ; 
    $tt = select_all($sql) ; 
...
<div class="conten"
        ...
        <div class="col-md-10">
            <table class="table table-hover" style="font-size: 13px; border: 1px solid #dedede;">
                <thead style="background-color: #2D3035;">
                    ...
                    <th width="120">
                        <a href="<?= BASE_URL?>admin/slide_anh/them.php" class="btn btn-info"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo BASE_URL?>admin/slide_anh/sua.php?id=<?= $key['id'] ?>"
                                class="btn btn-info btn-sm">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                            </a>
                            
                            <a onclick="return confirm('Bạn có chắc chắn muốn xóa loại hàng này không ?')"
                                href="<?php echo BASE_URL?>admin/slide_anh/xoa.php?id=<?= $key['id'] ?>"
    ...
    <?php
                                        for ($t = 1; $t <= $page; $t++) { ?>
            &nbsp;<a name="" id="" class="btn btn-secondary" href="<?php echo BASE_URL ?>admin/slide_anh/list.php?product=<?= $t ?>" role="button">
                <?= $t ?></a>
            <?php
                }
                ?>
